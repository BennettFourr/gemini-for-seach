    ...
    <div className="container mx-auto">
      <nav className="flex flex-row justify-between items-center mt-5 px-2">
        <div className="flex flex-row items-center gap-2">
          ...
          <span className="font-semibold">Gemini for Google (v{getExtensionVersion()})</span>
        </div>
      </nav>
      <main className="w-[500px] mx-auto mt-14">
        ...
        <Text className="my-1">
          The language used in Gemini response. <span className="italic">Auto</span> is recommended.
        </Text>
        <Select
          value={language}
